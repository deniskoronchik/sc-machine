...
{ std::stringstream __ss; __ss << __msg; ::utils::ScLog::GetInstance()->Message(__type, __ss.str(), __color); }
...
#define SC_LOG_INFO(__msg) { SC_LOG_COLOR(::utils::ScLog::Type::Info, __msg, ScConsole::Color::Reset) }
